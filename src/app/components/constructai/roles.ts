...
export const ROLES: Record<Role, Permissions> = {
  ...
  Client: {
    views: ["dashboard", "projects", "schedule","plans", "documents", "reports", "inbox", "announcements", "observations", "coordination", "correspondence", "directory", "company-docs", "inspections", "checklists", "buildflex-ai"],
  ...
  "QA/QC Officer": {
    views: ["projects", "schedule","plans", "tasks", "documents", "daily-log", "attendance", "punch-list", "field-view", "mobile-create", "inbox", "announcements", "observations", "action-plans", "coordination", "correspondence", "directory", "company-docs", "inspections", "checklists", "safety-incidents", "equipment", "buildflex-ai"],
    financials: false, approveAny: false, approveLimit: 0, createCO: false, manageTeam: false,
  ...
  "Site Engineer": {
    views: ["projects", "schedule","plans", "tasks", "documents", "daily-log", "attendance", "punch-list", "field-view", "mobile-create", "inbox", "announcements", "observations", "action-plans", "coordination", "correspondence", "crews", "directory", "company-docs", "inspections", "checklists", "safety-incidents", "equipment", "buildflex-ai"],
    financials: false, approveAny: false, approveLimit: 0, createCO: false, manageTeam: false,
  ...
  "Trade Lead": {
    views: ["projects", "schedule","plans", "tasks", "documents", "daily-log", "attendance", "punch-list", "field-view", "mobile-create", "inbox", "announcements", "observations", "action-plans", "coordination", "correspondence", "crews", "directory", "company-docs", "role-manager", "bidding", "invoicing", "inspections", "checklists", "safety-incidents", "equipment", "buildflex-ai"],
  ...
  Viewer: {
    views: ["dashboard", "projects", "schedule","change-order", "change-orders", "plans", "documents", "daily-log", "attendance", "punch-list", "commitments", "inbox", "announcements", "observations", "coordination", "correspondence", "directory", "company-docs", "role-manager", "bidding", "invoicing", "inspections", "checklists", "safety-incidents", "equipment", "buildflex-ai"],
    financials: false, approveAny: false, approveLimit: 0, createCO: false, manageTeam: false,
