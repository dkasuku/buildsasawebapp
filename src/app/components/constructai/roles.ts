...
export const ROLES: Record<Role, Permissions> = {
  ...
  Viewer: {
    views: ["dashboard", "projects", "schedule","change-orders", "plans", "documents", "daily-log", "attendance", "punch-list", "commitments", "inbox", "announcements", "observations", "coordination", "correspondence", "directory", "company-docs", "role-manager", "bidding", "invoicing", "inspections", "checklists", "safety-incidents", "equipment", "buildflex-ai"],
    financials: false, approveAny: false, approveLimit: 0, createCO: false, manageTeam: false,
